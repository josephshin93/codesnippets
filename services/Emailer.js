...
var Emailer = /** @class */ (function (_super) {
    ...
    Emailer.prototype.formatEmails = function (recipients) {
        return recipients.map(function (_a) {
            var email = _a.email;
            return new helper.Email(email);
        });
    };
    Emailer.prototype.addRecipients = function () {
    ...
    Emailer.prototype.send = function () {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        request = this.sendGridApi.emptyRequest({
                            method: 'POST',
                            path: '/v3/mail/send',
                            body: this.toJSON()
                        });
                        return [4 /*yield*/, this.sendGridApi.API(request)];
                    case 1:
                        response = _a.sent();
