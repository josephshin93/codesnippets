...
module.exports = function (app, firebase) {
    app.post('/api/add_snippet', function (req, res) {
        ...
        var _a = req.body, content = _a.content, description = _a.description, ownerID = _a.ownerID, status = _a.status, team = _a.team, title = _a.title;
        var snippet = {
            title: title,
            content: content,
    ...
    app.get('/api/snippets', function (req, res) {
        firebase.collection('snippets').orderBy('timeCreated', 'desc').get().then(function (snapshot) {
